...
def eval(num_imgs, eval_dir, annotation_dir, showbox, output_pickledir):
...
def parse_args():
    ...
    parser.add_argument('--eval_num', dest='eval_num',
                        ...
                        default=np.inf, type=int) # np.inf
