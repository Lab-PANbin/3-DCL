...
PRETRAINED_CKPT = '/home/FPN_pretrained_weights/' + weights_name + '.ckpt'
TRAINED_CKPT = os.path.join(ROOT_PATH, 'output/trained_weights')

EVALUATE_DIR = ROOT_PATH + '/output/evaluate_result_pickle/'
test_annotate_path = '/data/xml'
...
DECAY_STEP = [10000, 14000]
MAX_ITERATION = 28000

# -------------------------------------------- Data_preprocess_config
DATASET_NAME = 'NWPU'  # 'ship', 'spacenet', 'pascal', 'coco'
PIXEL_MEAN = [123.68, 116.779, 103.939]  # R, G, B. In tf, channel is RGB. In openCV, channel is BGR
IMG_SHORT_SIDE_LEN = 600  # 600  # 600
IMG_MAX_LENGTH = 1300  # 1000  # 1000
CLASS_NUM = 10
